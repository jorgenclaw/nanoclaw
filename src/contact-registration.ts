...
registerDeliveryAction(
  ...
  unguarded(
    'provisions users/agent-groups/messaging-groups/wirings from a container-originated request; ' +
      'not currently wired into the guard system — see .nanoclaw-migrations/09-misc-customizations-jul2026.md ' +
      'for a flagged follow-up to move this onto a real guard spec (akin to agents.create)',
  ),
);
