...
registerDeliveryAction(
  PASSPORT_AUTHORIZE_ACTION,
  (content, session, inDb) => handlePassportAuthorize(content, session, inDb, getAuthorizationService()),
  unguarded(
    'gated by the Passport signed-authorization handshake (issue → sign → verify), a distinct ' +
      'cryptographic WYSIWYS mechanism from the guard/hold chat-approval-card system — see ' +
